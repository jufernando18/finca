<?php
    ...
    $sql = "SELECT DISTINCT nombre FROM ".DB_TABLE_INGRESOS.";";
    ...
    $opcion=0;
    $sql = "SELECT DISTINCT descripcion FROM ".DB_TABLE_INGRESOS.";";
    $resultado = mysqli_query($con,$sql);//ejecutando el query      
    while ($row = mysqli_fetch_array($resultado)) {
    ...
    $opcion=0;
    $sql = "SELECT DISTINCT nombre FROM ".DB_TABLE_GASTOS.";";
    $resultado = mysqli_query($con,$sql);//ejecutando el query
    while ($row = mysqli_fetch_array($resultado)) {
    ...
    $opcion=0;
    $sql = "SELECT DISTINCT descripcion FROM ".DB_TABLE_GASTOS.";";
    $resultado = mysqli_query($con,$sql);//ejecutando el query    
    while ($row = mysqli_fetch_array($resultado)) {
